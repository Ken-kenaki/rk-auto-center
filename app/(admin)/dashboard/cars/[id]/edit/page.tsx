...
// Move Field outside component to prevent component remounting and losing input focus on every keystroke
      ...
      <div className="bg-white rounded-2xl border border-zinc-100 shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <Field label="Variant Spec">
            <input value={form.variant} onChange={(e) => set("variant", e.target.value)} className={inp} />
          </Field>
